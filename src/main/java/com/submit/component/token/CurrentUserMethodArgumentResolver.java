...
public class CurrentUserMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer modelAndViewContainer, NativeWebRequest nativeWebRequest, WebDataBinderFactory webDataBinderFactory) throws Exception {
        ...
        User user = (User) nativeWebRequest.getAttribute(String.valueOf(FnvHash.Constants.CURRENT_USER), RequestAttributes.SCOPE_REQUEST);
        if (user != null) {
            return user;
        }
        throw new MissingServletRequestPartException(String.valueOf(FnvHash.Constants.CURRENT_USER));
    }
}
